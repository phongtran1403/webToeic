...
<meta charset="utf-8" />
<title>Danh sách quản lí hướng dẫn ngữ pháp</title>
...
<body class="no-skin">
		...
		<div class="main-content-inner">
			<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				<ul class="breadcrumb">
					...
					<li class="active">Danh sách hướng dẫn ngữ pháp</li>
				</ul>
				<!-- /.breadcrumb -->
			</div>
		</div>
					...
					<div class="col-xs-12">
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<c:forEach var="list" items="${list}">
								<tbody>
									<tr>
										<td class="center">${list.idHuongDanNguPhap }</td>
										<td class="center">${list.tieuDe }</td>
										<td class="center">${list.anh}</td>
										<td class="center">
											<p>${list.noiDung}</p>
												<a href="GrammarGuidlineManage?id=${list.idHuongDanNguPhap }">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<button class="btn btn-white btn-info btn-bold"
							...
							<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i> Thêm tên
							bài hướng dẫn
						</button>

						<button class="btn btn-white btn-info btn-bold"
							data-toggle="modal" data-target="#myModal2">
							<i class="ace-icon fa fa-floppy-o bigger-120 blue"></i>Thêm ảnh
						</button>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<form action="InsertGrammarGuidlineName" method="post">
	...
	<div class="modal fade" id="myModal2" role="dialog">
		<div class="modal-dialog">
			...
			<form action="InsertImage" method="get">

				<!-- Modal content-->
				<div class="modal-content">

					<div class="modal-header">
						<h4 class="modal-title">ID ảnh</h4>
					</div>
					<div class="modal-body">
						<p>Nhập vào id ảnh.</p>
						<input type="text" class="col-xs-10 col-sm-5" name="idAnh"/>
							<!-- required="required" pattern="[0-9]" --> 
					</div>
					<div class="modal-footer">
						<button onclick="consoleLog" class="btn btn-default" type="submit">
							Xác nhận</button>
					</div>
				</div>
			</form>
